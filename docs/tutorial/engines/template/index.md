...
For each engine family, we have four[^1] different files; accordingly, we mainly
have four different template files. Each template file comes with an example
file, which can be opened side by side.

1. [[Engine Overview Template]] | [[Ticker Engine Overview | Example]]
2. [[Engine Environment Template]] | [[Ticker Engine Environment | Example]]
3. [[Engine Protocol Types Template]] | [[Ticker Engine Protocol Types | Example]]
4. [[Engine Dynamics Template]] | [[Ticker Engine Dynamics | Example]]
