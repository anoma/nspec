...
We define a _compositional cybernetic agency protocol_ as a protocol which allows for all of these functions. We define the Anoma protocol $Anoma$ as the unique such protocol without loss of generality. This implies further requirements which are outlined in the next section, [protocol desiderata](./protocol-desiderata.md).
