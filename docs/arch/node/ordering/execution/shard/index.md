...
--8<-- "shard/kvs_acquire_lock.md:all"

--8<-- "shard/kvs_read_request.md:all"

--8<-- "shard/kvs_write.md:all"

--8<-- "shard/update_seen_all.md:all"

--8<-- "shard/timestamp_ordering_information.md:all"

--8<-- "shard/anchor_chosen.md:all"
