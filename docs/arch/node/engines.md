...
- [Consensus](./engines/consensus_v1.md#consensus)
...
- a [consensus](./engines/consensus_v1.md#consensus), which orders transaction requests collected by the mempool, and
...
These headers are ultimately what the [consensus](./engines/consensus_v1.md#consensus) decides on, in order to establish a total order of transactions for the [execution engine](./engines/execution.md#execution).
[Read more here.](./engines/mempool.md#mempool)

- **[Consensus](./engines/consensus_v1.md#consensus):** Our consensus is based on [Heterogeneous Paxos](https://arxiv.org/abs/2011.08253).
...
[Read more here.](./engines/consensus_v1.md#consensus)
