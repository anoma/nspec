...
??? note "Juvix preamble"
    ...
    import arch.node.types.engine_dynamics open;
...
!!! quote ""
    ...
    --8<-- "./docs/arch/node/engines/ticker_dynamics.juvix.md:DoIncrement"
...
!!! quote ""
    ...
    ```
    --8<-- "./docs/arch/node/engines/ticker_dynamics.juvix.md:ReplyTo"
    ```
...
--8<-- "./docs/arch/node/engines/ticker.juvix.md:ticker-engine-family"